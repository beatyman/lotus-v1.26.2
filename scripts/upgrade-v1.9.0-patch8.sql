...
update storage_info set mount_signal_uri=substr(mount_signal_uri,1,length(mount_signal_uri)-5)||":/data/zfs" where mount_type='lotus-storage' and kind=0 and substr(mount_signal_uri,length(mount_signal_uri)-9, 5)=':1332';
update storage_info set mount_signal_uri=substr(mount_signal_uri,1,length(mount_signal_uri)-5)||":/data/zfs1" where mount_type='lotus-storage' and kind=0 and substr(mount_signal_uri,length(mount_signal_uri)-9, 5)=':1342';
update storage_info set mount_signal_uri=substr(mount_signal_uri,1,length(mount_signal_uri)-5)||":/data/zfs2" where mount_type='lotus-storage' and kind=0 and substr(mount_signal_uri,length(mount_signal_uri)-9, 5)=':1352';
