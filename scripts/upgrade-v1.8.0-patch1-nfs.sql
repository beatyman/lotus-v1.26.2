...
-- update storage_info set mount_signal_uri=substr(mount_signal_uri,1,length(mount_signal_uri)-10)||":1332" where mount_type='nfs' and kind=0 and substr(mount_signal_uri,length(mount_signal_uri)-9, 10)=':/data/zfs';
