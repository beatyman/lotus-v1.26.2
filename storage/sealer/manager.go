...
func (m *Manager) SectorsUnsealPiece(ctx context.Context, sector storiface.SectorRef, offset storiface.UnpaddedByteIndex, size abi.UnpaddedPieceSize, ticket abi.SealRandomness, unsealed *cid.Cid) error {
	return m.hlmWorker.UnsealPiece(ctx, sector, offset, size, ticket, *unsealed)
...
func (m *Manager) PledgeSector(ctx context.Context, sectorID storiface.SectorRef, existingPieceSizes []abi.UnpaddedPieceSize, sizes ...abi.UnpaddedPieceSize) ([]abi.PieceInfo, error) {
...
func (m *Manager) SealCommit(ctx context.Context, sector storiface.SectorRef, ticket abi.SealRandomness, seed abi.InteractiveSealRandomness, pieces []abi.PieceInfo, cids storiface.SectorCids) (storiface.Proof, error) {
...
func (m *Manager) FinalizeSector(ctx context.Context, sector storiface.SectorRef) error {
	return m.hlmWorker.FinalizeSector(ctx, sector)
	ctx, cancel := context.WithCancel(ctx)
	defer cancel()
