//go:build !debug && !2k && !testground && !calibnet && !butterflynet && !interopnet && !hlm
// +build !debug,!2k,!testground,!calibnet,!butterflynet,!interopnet,!hlm
...
var PropagationDelaySecs = uint64(18)
