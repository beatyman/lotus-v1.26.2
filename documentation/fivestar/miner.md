...
## Development environment installation(开发环境安装)
```shell
apt-get update
...
## Installation skills in China(国内安装技巧)
...
```
/data -- All data directory of the project(项目数据目录)

# SSD cache of seal worker(缓存盘)
