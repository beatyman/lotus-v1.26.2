...
func (sm *StorageMinerAPI) SectorAddPieceToAny(ctx context.Context, size abi.UnpaddedPieceSize, r storiface.PieceData, d piece.PieceDealInfo) (api.SectorOffset, error) {
