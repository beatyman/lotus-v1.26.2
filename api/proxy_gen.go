...
func (c *StorageMinerStruct) ProxyStatus(ctx context.Context, cond ProxyStatCondition) (*ProxyStatus, error) {
...
func (c *StorageMinerStruct) HlmSectorListAll(ctx context.Context) ([]SectorInfo, error) {
