...
type FullNode interface {
	...
	MpoolPushMessage(ctx context.Context, auth []byte, msg *types.Message, spec *MessageSendSpec) (*types.SignedMessage, error) //perm:sign
	...
	MpoolBatchPushMessage(context.Context, []byte, []*types.Message, *MessageSendSpec) ([]*types.SignedMessage, error) //perm:sign
