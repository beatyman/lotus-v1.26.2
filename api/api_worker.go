...
type Worker interface {
	...
	AddPiece(ctx context.Context, sector storiface.SectorRef, pieceSizes []abi.UnpaddedPieceSize, newPieceSize abi.UnpaddedPieceSize, pieceData storiface.PieceData) (storiface.CallID, error)                    //perm:admin
