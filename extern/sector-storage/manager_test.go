...
func newTestMgr(ctx context.Context, t *testing.T, ds datastore.Datastore) (*Manager, *stores.Local, *stores.Remote, *stores.Index, func()) {
	...
	prover, err := ffiwrapper.New(ffiwrapper.RemoteCfg{}, &readonlyProvider{stor: lstor, spt: cfg.SealProofType}, cfg)
	require.NoError(t, err)
	...
	m.hlmWorker, err = NewHlmWorker(ffiwrapper.RemoteCfg{}, WorkerConfig{
